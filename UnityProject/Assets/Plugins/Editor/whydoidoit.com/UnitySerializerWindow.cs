...
public class UnitySerializerWindow : EditorWindow
{
	...
	{
		var tmp = UnityEngine.Resources.FindObjectsOfTypeAll(typeof(AnimationClip))
			.Concat(UnityEngine.Resources.FindObjectsOfTypeAll(typeof(AudioClip)))
			.Concat(UnityEngine.Resources.FindObjectsOfTypeAll(typeof(Mesh)))
			.Concat(UnityEngine.Resources.FindObjectsOfTypeAll(typeof(Material)))
			.Concat(UnityEngine.Resources.FindObjectsOfTypeAll(typeof(Texture)))
			.Distinct()
			.ToList();
		var assets = tmp
