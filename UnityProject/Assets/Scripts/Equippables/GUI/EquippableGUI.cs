    ...
    void OnGUI() {
        ...
        GUI.BeginGroup(inventoryRectNormalized);
		{
			...
			GUI.BeginGroup(rightbox);
			{
				...
				GUI.Label (new Rect(5,25, 255, 20), "Attack: " + (inventory.getEquippedEquipable() == null ? 0 : inventory.getEquippedEquipable().statPower), GoodStatus);
				...
				GUI.Label (new Rect(5,45, 255, 20), "Speed: " + movementSpeed.GetSpeed(), GoodStatus);
				GUI.Label (new Rect(5,65, 255, 20), "Head: " + PlayerData.bodyPartHealth[0].ToString ("##.") + "/100", GetTextColor (PlayerData.bodyPartHealth[0]/100f));
				GUI.Label (new Rect(5,85, 255, 20), "Torso: " + PlayerData.bodyPartHealth[1].ToString ("##.") + "/500", GetTextColor (PlayerData.bodyPartHealth[1]/500f));
				GUI.Label (new Rect(5,105, 255, 20), "Left Arm: " + PlayerData.bodyPartHealth[2].ToString ("##.") + "/100", GetTextColor (PlayerData.bodyPartHealth[2]/100f));
				GUI.Label (new Rect(5,125, 255, 20), "Right Arm: " + PlayerData.bodyPartHealth[3].ToString ("##.") + "/100", GetTextColor (PlayerData.bodyPartHealth[3]/100f));
				GUI.Label (new Rect(5,145, 255, 20), "Left Leg: " + PlayerData.bodyPartHealth[4].ToString ("##.") + "/200" , GetTextColor (PlayerData.bodyPartHealth[4]/200f));
				GUI.Label (new Rect(5,165, 255, 20), "Right Leg: " + PlayerData.bodyPartHealth[5].ToString ("##.") + "/200", GetTextColor (PlayerData.bodyPartHealth[5]/200f));
